							...
							<c:forEach items="${pros }" var="pro">
								<tr>
									<td><i class="fab fa-angular fa-lg text-danger me-3"></i>
										<strong>${pro.productDetails.get(0).id }</strong></td>
									<td>${pro.name }</td>
									<td><img class="imgPro" width="70px" height="70px" src="<c:url value="/template/image/${pro.productDetails.get(0).image.imgName}"/>"></td>
									<td>${pro.price }</td>
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu">
												<a class="dropdown-item" href="list-contest-candidates/"><i
													...
													Show history vote</a> <a class="dropdown-item" href="edit/${pro.productDetails.get(0).id }"><i
													class="bx bx-edit-alt me-1"></i> Edit Contest</a> 
