			...
			<div class="card">
				<div class="card-body">
					...
					<form:form id="formAuthentication" class="mb-3" method="POST"
						modelAttribute="account" action="register">
						<div class="mb-3">
							...
							<form:input type="text" class="form-control" id="Fullname"
								path="fullName" placeholder="Enter your username"
								autofocus="autofocus" />
					...
					<div class="col">
						<a href="#" class="fb btn"> <i class="fa fa-facebook fa-fw"></i>
							...
							href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/spring-mvc-project/login-google&response_type=code
    &client_id=195851300604-32sho9b3g2se5j27vi13mur8sclho8du.apps.googleusercontent.com&approval_prompt=force"
							class="google btn"> <i class="fa fa-google fa-fw"></i> Login
							with Google+
						</a>
					</div>
					<p class="text-center">
